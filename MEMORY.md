...
Combat vet, electrical engineer, Indiana. Building AI tools (LIMEN, Stillpoint, TASNI) and recovering. Hates overengineering. Keep it simple. Don't build servers when a file works.
...
- Test GitHub Action issue-to-log
